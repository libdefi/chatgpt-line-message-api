...
export declare type ChangeHotswapResult = Array<HotswappableChange | NonHotswappableChange>;
...
export declare type PropDiffs = Record<string, cfn_diff.PropertyDifference<any>>;
